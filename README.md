...
> Six models. Four attribution paradigms. One question:  
> *If models with fundamentally different inductive biases independently flag the same tokens — what are they detecting?*
